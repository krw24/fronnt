        ...
        <div className="w-full h-screen  flex flex-row ">
            <div className="w-20 h-screen bg-red-500">
                ...
                <div className="w-full h-[calc(100vh-80px)] bg-slate-200 flex flex-col">
                    <div className="w-full h-20 bg-yellow-500 flex justify-center items-center ">
                    ...
                    <div className="w-full h-[calc(100vh-100px)] bg-purple-500"></div>
                </div>
            </div>
            <div className="flex flex-col w-full h-full bg-blue-500">
                ...
                <div className="w-full h-[calc(100vh-80px)] bg-yellow-500">
